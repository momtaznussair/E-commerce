<div>
    <div class="row d-flex justify-content-between px-4">
        <div class="col-3" x-data="{ showActive: true }">
           <div class="row mx-2">
            <div class="custom-control custom-switch">
                <input wire:model='trashed' @change="showActive = !showActive; $wire.set('active', showActive)" type="checkbox"  class="custom-control-input" id="trashed">
                <label class="custom-control-label tx-danger" for="trashed">{{__('Trashed')}}</label>
            </div>
            <div x-show="showActive" class="custom-control custom-switch mx-2">
