                         ...
                         <td>
                            @can('City_edit')
                             <div class="custom-control custom-switch">
                                 <input wire:change="toggleActive({{$city->active}})" wire:click="select({{$city}})"
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col">
                            ...
                            @error('country_id') <div class="tx-danger mt-1"><strong>{{ $message }}</strong></div> @enderror
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        @this.on('reset-add-form', function() {
            $('#CityName').val(null).trigger('change');
