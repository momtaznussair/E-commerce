<div class="card-body">
					   ...
					   <td>
                        ...
                        <td>
                            ...
                            <div class="custom-control custom-switch">
                                ...
                                type="checkbox" {{ $Admin->active ? 'checked' : '' }} {{ ($Admin->deleted_at || $admins->count() == 1) ? 'disabled' : '' }} class="custom-control-input" id="{{$Admin->id}}">
                        ...
                        <td>
                            ...
                            @can('Admin_delete')
                                @if ($Admin->deleted_at)
                                    ...
                                    @else
							        @if ($admins->count() > 1 && ! $Admin->hasRole('Super Admin'))
                                    <a
                                        wire:click="select({{$Admin}})"
                                        class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
    ...
    <x-crud-by-name-modal :name="$name" :title="__('Delete Permanently')" mode="forceDelete" />
